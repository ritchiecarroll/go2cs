...
for b in ${C2Q44_SHA:+${C2Q44_BRANCH:-claude/c2-q44-cut}} ${C2INC9_SHA:+${C2INC9_BRANCH:-claude/c2-darwin-inc9}} ${C2Q56L_SHA:+${C2Q56L_BRANCH:-claude/c2-q56-lift}} ${C2INC10_SHA:+${C2INC10_BRANCH:-claude/c2-darwin-inc10}} ${SUBQ63_SHA:+${SUBQ63_BRANCH:-claude/sub-q63}} ${SUBQ60_SHA:+${SUBQ60_BRANCH:-claude/sub-q60}} ${SUBQ59_SHA:+${SUBQ59_BRANCH:-claude/sub-q59}} ${GBD_SHA:+${GBD_BRANCH:-claude/g-design-b-outparam}} ${GED_SHA:+${GED_BRANCH:-claude/g-design-e-elemaddr}} ${GCD_SHA:+${GCD_BRANCH:-claude/g-design-c-strwindow}} ${GFVCR_SHA:+${GFVCR_BRANCH:-claude/g-fvc-record-measured}} ${RE2B_SHA:+${RE2B_BRANCH:-claude/reflect-embedded-inc-e2b}} ${C1Q61_SHA:+${C1Q61_BRANCH:-claude/c1-runtime-q61-parkhook}} ${C1Q64_SHA:+${C1Q64_BRANCH:-claude/c1-runtime-q64-sigign}} ${C1Q58D_SHA:+${C1Q58D_BRANCH:-claude/c1-q58-design}} ${GDC_SHA:+${GDC_BRANCH:-claude/g-deferred-class}}; do
