...
for b in ${C2Q44_SHA:+${C2Q44_BRANCH:-claude/c2-q44-cut}} ${C2Q49_SHA:+${C2Q49_BRANCH:-claude/c2-q49-cut}} ${GFVC_SHA:+${GFVC_BRANCH:-claude/g-field-view-cut}} ${GA_SHA:+${GA_BRANCH:-claude/g-elem-take-concrete}} ${SUBQ57_SHA:+${SUBQ57_BRANCH:-claude/sub-q57}} ${C1RT6_SHA:+${C1RT6_BRANCH:-claude/c1-runtime-inc6-mem}} ${C1RT7_SHA:+${C1RT7_BRANCH:-claude/c1-runtime-inc7-w2a}} ${RE3B_SHA:+${RE3B_BRANCH:-claude/reflect-value-singles-inc-e3}} ${C2Q56D_SHA:+${C2Q56D_BRANCH:-claude/c2-q56-design}} ${C2Q52D_SHA:+${C2Q52D_BRANCH:-claude/c2-q52-design}} ${C2INC7_SHA:+${C2INC7_BRANCH:-claude/c2-darwin-inc7}} ${C2INC8_SHA:+${C2INC8_BRANCH:-claude/c2-darwin-inc8}} ${C2Q52B_SHA:+${C2Q52B_BRANCH:-claude/c2-q52-bridge}} ${SUBQ62_SHA:+${SUBQ62_BRANCH:-claude/sub-q62}} ${SUBDOC11_SHA:+${SUBDOC11_BRANCH:-claude/sub-doc11}}; do
