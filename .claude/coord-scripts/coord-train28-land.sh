...
for b in ${C2Q44_SHA:+${C2Q44_BRANCH:-claude/c2-q44-cut}} ${C2Q49_SHA:+${C2Q49_BRANCH:-claude/c2-q49-cut}} ${C1RT4_SHA:+${C1RT4_BRANCH:-claude/c1-runtime-inc4-getg}} ${C1RT5_SHA:+${C1RT5_BRANCH:-claude/c1-runtime-inc5-q54}} ${SUBQ45C_SHA:+${SUBQ45C_BRANCH:-claude/sub-q45}} ${SUBQ50_SHA:+${SUBQ50_BRANCH:-claude/sub-q50}} ${GFVC_SHA:+${GFVC_BRANCH:-claude/g-field-view-cut}} ${RE2_SHA:+${RE2_BRANCH:-claude/reflect-field-metadata-inc-e2}} ${C2Q41F_SHA:+${C2Q41F_BRANCH:-claude/c2-q41-frames}} ${GFVD_SHA:+${GFVD_BRANCH:-claude/g-field-view-design}} ${C2INC6_SHA:+${C2INC6_BRANCH:-claude/c2-darwin-inc6}} ${RE3_SHA:+${RE3_BRANCH:-claude/reflect-value-singles-inc-e3}} ${SUBQ22_SHA:+${SUBQ22_BRANCH:-claude/sub-q22}} ${C1Q46_SHA:+${C1Q46_BRANCH:-claude/c1-q46-hostfatal}} ${SUBQ55_SHA:+${SUBQ55_BRANCH:-claude/sub-q55}} ${SUBQ57_SHA:+${SUBQ57_BRANCH:-claude/sub-q57}}; do
