...
for b in ${SUBQ32_SHA:+claude/sub-q32} ${C1Q34_SHA:+${C1Q34_BRANCH:-claude/c1-q34-census}} ${C2CENSUS_SHA:+${C2CENSUS_BRANCH:-claude/c2-darwin-board-t24}} ${C1Q31_SHA:+${C1Q31_BRANCH:-claude/c1-q31-host-condition}} ${SUBQ36_SHA:+claude/sub-q36} ${SUBQ27_SHA:+claude/sub-q27} ${C1RT1_SHA:+${C1RT1_BRANCH:-claude/c1-runtime-inc1-sigprocmask}} ${GQ35_SHA:+${GQ35_BRANCH:-claude/g-q35-i1-l3-footprint}} ${C2INC5_SHA:+${C2INC5_BRANCH:-claude/c2-darwin-sigprocmask}} ${SUBQ39_SHA:+claude/sub-q39} ${SUBQ29_SHA:+claude/sub-q29} ${C2CRASH_SHA:+${C2CRASH_BRANCH:-claude/c2-darwin-crashreport}} ${RINC2_SHA:+claude/reflect-cargo-inc-2} ${GB_SHA:+claude/g-b-defer-finally}; do
