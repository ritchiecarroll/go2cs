...
git fetch -q origin master && git checkout -q --detach 0aed0a459 || { echo "checkout failed"; exit 1; }
echo "control tree: $(git rev-parse --short=9 HEAD) (the pointer-token seat merge)"
