...
git fetch -q origin master && git checkout -q --detach 75758cf06 || { echo "checkout failed"; exit 1; }
echo "control tree: $(git rev-parse --short=9 HEAD) (the BARE assembly head, pre-repair)"
