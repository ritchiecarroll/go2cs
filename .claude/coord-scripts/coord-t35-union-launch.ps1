$log = '$env:USERPROFILE\AppData\Local\Temp\claude\C--Projects-go2cs--claude-worktrees-go2cs-fleet-train-19-7d1cc7\388822cf-bade-49e8-96a9-7ab378101ad4\scratchpad\coord-t35-union-0907-0936.log'
$env:UNIONLOG = $log
