#!/bin/bash
# Wait for train 16's slnx leg to end (the GolibTests leg's stamp), then purge the worktree's behavioral build output
...
T="$HOME/AppData/Local/Temp/claude/C--Projects-go2cs--claude-worktrees-musing-moser-d4552c/974e234b-551b-4d2a-8d0f-7e0c9bfaad1f/tasks/bkepyxamv.output"
stamp(){ echo "[$(date '+%F %T')] $*"; }
